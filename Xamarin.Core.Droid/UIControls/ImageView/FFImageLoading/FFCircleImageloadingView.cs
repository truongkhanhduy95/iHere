...
{
	public class FFCircleImageloadingView : FFImageLoadingView
	{
		...
		protected FFCircleImageloadingView(IntPtr javaReference, JniHandleOwnership transfer)
					: base(javaReference, transfer)
		{
		}

		public FFCircleImageloadingView(Context context)
					: base(context)
		{
			Initialize();
		}

		public FFCircleImageloadingView(Context context, IAttributeSet attrs)
					: base(context, attrs)
		{
			Initialize();
		}
